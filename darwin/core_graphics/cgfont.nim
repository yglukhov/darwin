...
proc getGlyphAdvances*(font: CGFont, glyphs: ptr CGGlyph, count: csize_t, advances: ptr cint): bool {.importc: "CGFontGetGlyphAdvances".}
proc getGlyphBBoxes*(font: CGFont, glyphs: ptr CGGlyph, count: csize_t, bboxes: ptr CGRect): bool {.importc: "CGFontGetGlyphBBoxes".}

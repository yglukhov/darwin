...
proc fileSystemRepresentation*(url: CFURL, resolveAgainstBase: Boolean, buffer: ptr uint8, maxBufLen: CFIndex): Boolean {.importc: "CFURLGetFileSystemRepresentation".}
